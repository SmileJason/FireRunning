...
import com.weijie.firerunning.BuildConfig;
...
public class PinnedSectionListView extends ListView {
	...
	void createPinnedShadow(int position) {
		...
		/*View pinnedView = inflater.inflate(R.layout.item_plan_week, PinnedSectionListView.this, false);
		TrainPlan plan = ((PlanAdapter)getAdapter()).getItem(position);
		TextView title = (TextView) pinnedView.findViewById(R.id.title);
		title.setText(plan.text);
		TextRoundCornerProgressBar progress = (TextRoundCornerProgressBar) pinnedView.findViewById(R.id.progress);
		progress.setMax(100);
		progress.setProgress(30);
		progress.setProgressText("11公里");*/
		
		
		//View pinnedView = ((PlanAdapter)getAdapter()).getListTop();
		// read layout parameters
		LayoutParams layoutParams = (LayoutParams) pinnedView.getLayoutParams();
		//android.view.ViewGroup.LayoutParams layoutParams = ((PlanAdapter)getAdapter()).getTopParams();
		...
		//int ws = MeasureSpec.makeMeasureSpec(widthSize, widthMode);
